...
public class RoundRectGuiElementRenderState implements SimpleGuiElementRenderState {
    ...
    public RoundRectGuiElementRenderState(RenderPipeline pipeline, TextureSetup texture, Matrix3x2f pose, float x, float y, float w, float h, float r, int color1, int color2, int color3, int color4, int colorCenter, ScreenRect scissor, ScreenRect bounds) {
    ...
    public RoundRectGuiElementRenderState(Matrix3x2f pose, float x, float y, float w, float h, float r, int color1, int color2, int color3, int color4, int colorCenter, ScreenRect scissor) {
        this(PIPELINE_QUADS, TextureSetup.empty(), pose,
                x, y, w, h, Math.clamp(r, 0, Math.min(w, h) / 2),
    ...
    public RoundRectGuiElementRenderState(DrawContext context, float x, float y, float w, float h, float r, int color1, int color2, int color3, int color4, int colorCenter) {
        this(new Matrix3x2f(context.getMatrices()), x, y, w, h, r, color1, color2, color3, color4, colorCenter, context.scissorStack.peekLast());
    }

    public RoundRectGuiElementRenderState(DrawContext context, float x, float y, float w, float h, float r, int color) {
